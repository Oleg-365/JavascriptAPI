...
filterElementByDataAttribute('data-price', 75);

// На странице есть список элементов, каждый из которых имеет атрибут data-rating, содержащий рейтинг
// товара. Создайте функцию, которая сортирует элементы в порядке убывания рейтинга и переставлет их
//  на странице в соответствии с новым порядкомю
